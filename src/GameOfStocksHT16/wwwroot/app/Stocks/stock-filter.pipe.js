...
var StockFilterPipe = (function () {
    ...
    StockFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (stock) {
            return stock.name.toLocaleLowerCase().indexOf(filterBy) !== -1;
        }) : value;
    };
